...
<body>
	...
	<form id="msform" method="post" action="authentication">
		<div id="progressbar">
			<div class="welcome"
		...
		<fieldset class="myForm">
			<h2 class="fs-title">Please Login To Enter</h2>
			...
			<button type="submit" class="previous action-button" value="submit"
				...
				<i class="bi bi-rocket-takeoff-fill" style="color: yellow;">&nbsp;&nbsp;</i>Enter
			</button>

			<button type="button" class="previous action-Mybutton" id="myButton"
				style="border-radius: 10px;">
				<i class="bi bi-skip-backward-fill" style="color: yellow">&nbsp;&nbsp;</i>Back
			</button>
			<button type="button" class="previous action-Signbutton"
				id="signButton"
			...
			<c:if test="${not empty error}">
				...
				<div style="color: darkblue; font-size: 12px; font-weight: bold;">Please
					Sign up If You Are New....</div>
			</c:if>
		</fieldset>
	</form>
